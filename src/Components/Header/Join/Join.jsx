...
function Join() {
                ...
                [
                    {
                        ...
                        inpId: "email",
                        clear: <svg aria-hidden="true" className="clear valign-middle color-red flex-shrink-none" focusable="false" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" style={{ width: "24px", height: "24px", overflow: "visible", fill: "currentcolor" }}><path d="M9.1005 3H14.8995C15.4299 3 15.9386 3.21071 16.3137 3.58579L20.4142 7.68629C20.7893 8.06136 21 8.57007 21 9.1005L21 14.8995C21 15.4299 20.7893 15.9386 20.4142 16.3137L16.3137 20.4142C15.9386 20.7893 15.4299 21 14.8995 21H9.10051C8.57007 21 8.06136 20.7893 7.68629 20.4142L3.58579 16.3137C3.21071 15.9386 3 15.4299 3 14.8995V9.10051C3 8.57007 3.21071 8.06136 3.58579 7.68629L7.68629 3.58579C8.06136 3.21071 8.57007 3 9.1005 3ZM16.7071 7.29289C16.3166 6.90237 15.6834 6.90237 15.2929 7.29289L12 10.5858L8.70711 7.29289C8.31658 6.90237 7.68342 6.90237 7.29289 7.29289C6.90237 7.68342 6.90237 8.31658 7.29289 8.70711L10.5858 12L7.29289 15.2929C6.90237 15.6834 6.90237 16.3166 7.29289 16.7071C7.68342 17.0976 8.31658 17.0976 8.70711 16.7071L12 13.4142L15.2929 16.7071C15.6834 17.0976 16.3166 17.0976 16.7071 16.7071C17.0976 16.3166 17.0976 15.6834 16.7071 15.2929L13.4142 12L16.7071 8.70711C17.0976 8.31658 17.0976 7.68342 16.7071 7.29289Z"></path></svg>,
                        errorr: "Please enter your email address..",
                        remember: "This will be your username"
                    },
                    {
                        label: "* password",
                        type: 'password',
                        inpId: "passInput",
                        errorr: "Enter a password.",
                        errorr2: "Not satisfied:From 8 to 25 characters",
                        errorr3: "At least one number",
                        errorr4: "Not satisfied:At least one capital letter",
                        errorr5: "At least one lowercase letter",
                        errorr6: "At least one special character such as exclamation point or comma",
                        remember: "Create a password 8 to 25 characters long that includes at least 1 uppercase and 1 lowercase letter, 1 number and 1 special character like an exclamation point or asterisk.",
    ...
    const alreadyHandle = () => {
        setHavecard(!havecard)
    }
    return (
        <div className='sign-shadow'>
            <div className='containerr sign join'>
                ...
                <form className='sign-box join-box'>
                    <p>* indicates required field</p>

                    <div className='username-boxes'>
                        {data.map(item => {
                            return <CreateAccount key={nanoid()} {...item} />
                        })}
                    </div>

                    <div className='form-content'>
                        <div onClick={alreadyHandle} className='already-have forgot'>Already have a Starbucks gift card? {havecard ? <BsChevronUp /> : <BsChevronDown />}</div>
                        <div className={havecard ? 'show-form' : 'hide-form'}>
                            <p className='collect'>COLLECT MORE STARS & EARN REWARDS</p>
                            <p className='message-mail'>Email is a great way to know about offers and what’s new from Starbucks.</p>

                            <div className='keep-signed'>
                                <div><input id='signed' type="checkbox" /></div>
                                <label htmlFor="signed" className='signed-label'>Yes, I’d like email from Starbucks</label>
                            </div>
                            <p className='anouncment'>Know about initiatives, announcements and product offers.</p>
                            <p className='collect terms'>TERMS OF USE</p>
                            <div className='terms-content'>
                                <div> <input id='signed' type="checkbox" /></div>
                                <label htmlFor="signed" className='signed-label '>I agree to the <Link className='question-link'><span>Starbucks® Rewards Terms</span>
                                ...
                                </Link>   and the <Link className='question-link'><span>Starbucks Card Terms</span>
                                        <svg className='link-icon' aria-hidden="true" focusable="false" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" ><path d="M14.75 18H7.875C6.84 18 6 17.16 6 16.125V9.25c0-1.036.84-1.875 1.875-1.875h5.11c.276 0 .5.224.5.5s-.224.5-.5.5h-5.11c-.483 0-.875.392-.875.875v6.875c0 .483.392.875.875.875h6.875c.483 0 .875-.392.875-.875V11c0-.276.224-.5.5-.5s.5.224.5.5v5.125c0 1.035-.84 1.875-1.875 1.875zM14 6.5c0-.276.224-.5.5-.5h3c.276 0 .5.224.5.5v3c0 .276-.224.5-.5.5s-.5-.224-.5-.5V7.72l-4.66 4.74c-.19.196-.507.2-.704.005-.197-.193-.2-.51-.006-.707L16.307 7H14.5c-.276 0-.5-.224-.5-.5z"></path></svg>
                                    </Link> and have read the<Link className='question-link'><span>Starbucks Privacy Statement</span>
                                        <svg className='link-icon' aria-hidden="true" focusable="false" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" ><path d="M14.75 18H7.875C6.84 18 6 17.16 6 16.125V9.25c0-1.036.84-1.875 1.875-1.875h5.11c.276 0 .5.224.5.5s-.224.5-.5.5h-5.11c-.483 0-.875.392-.875.875v6.875c0 .483.392.875.875.875h6.875c.483 0 .875-.392.875-.875V11c0-.276.224-.5.5-.5s.5.224.5.5v5.125c0 1.035-.84 1.875-1.875 1.875zM14 6.5c0-.276.224-.5.5-.5h3c.276 0 .5.224.5.5v3c0 .276-.224.5-.5.5s-.5-.224-.5-.5V7.72l-4.66 4.74c-.19.196-.507.2-.704.005-.197-.193-.2-.51-.006-.707L16.307 7H14.5c-.276 0-.5-.224-.5-.5z"></path></svg>
                                    </Link>
                                </label>
                            </div>
                    ...
                    <div className='submit'><button>Create Account</button></div>
