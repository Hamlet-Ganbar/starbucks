import './RewardsQuestion.css'
import { Link } from 'react-router-dom'

function RewardsQuestion() {
  return (
    <div className='question-container'>
      ...
      <p>We want to help in any way we can. You can ask your barista anytime or we’ve answered the most commonly asked questions
        right over here
        opens in new window <Link className='question-link'><pre>right over here</pre>
...
export default RewardsQuestion